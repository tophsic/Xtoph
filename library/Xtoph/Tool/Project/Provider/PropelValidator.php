    ...
    extends Xtoph_Tool_Project_Provider_Abstract
{
   ...
   {
      $this->_registry->getResponse()->appendContent('TODO: create action in propel-validator provider');
   }

   public function delete()
   {
      $this->_registry->getResponse()->appendContent('TODO: delete action in propel-validator provider');
   }
